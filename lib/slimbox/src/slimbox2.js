	...
	*/
	...
	$.slimbox = function(_images, startImage, _options) {
		options = $.extend({
			...
			counterText: "‘ото {x} из {y}<br>¬перЄд и назад - клавиши &rarr; и &larr;",	// Translate or change as you wish, or set it to false to disable counter text for image groups
