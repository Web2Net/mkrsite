...
//	window.parent.location.href='<?=SITE_URL?>/register/step3.html';
	...
	window.parent.document.getElementById("crop<?=$num?>").style.display = 'none';
	window.parent.document.getElementById("seeImage<?=$num?>").style.display = 'block';		
	window.parent.document.getElementById("seeImage<?=$num?>").src = '<?=str_replace(getenv("DOCUMENT_ROOT"),"",$_GET["file"]);?>';	
...
$ci->setExtraParameters(array('num' =>$num, 'test' => '1', 'fake' => 'this_var'));
