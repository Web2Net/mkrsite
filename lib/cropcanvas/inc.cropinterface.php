...
<!--    <div id="cropDetails">
    ...
    <div id="cropImage"><img src="<?php echo $this->getImageSource(); ?>" alt="image" title="Обрезать картинку" name="theImage" id="theImage" /></div>
<!--     <div id="cropResize">
   ...
   <div id="cropSizes">
    ...
    <div id="cropSubmit">
        <input style="cursor:pointer" type="submit" value="Обрезать картинку" id="cropSubmitButton" onClick="cc_Submit();" />
    </div>
</div>
